...
const writeCommits = async (Id, userId, userName, repo, created, results) => {
    const query = 'INSERT INTO commits(Id, userId, userName, repo, created) VALUES (?,?,?,?,?);';

    const queryData = [Id, userId, userName, repo, created];
